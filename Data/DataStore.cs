...
namespace ClinicaSePrice.Data
{
    public static class DataStore
    {
        public static List<Paciente> Pacientes = new List<Paciente>
        {
            ...
            new Paciente{ Nombre="José Rodriguez", Dni="50123123", FechaNacimiento=new DateTime(1981,6,21), Email="pepe@gmail.com", ObraSocial="OSDE"},
            new Paciente{ Nombre="Carlos García", Dni="60123123", FechaNacimiento=new DateTime(1994,12,1), Email="charly@hotmail.com", ObraSocial="particular"},
            new Paciente{ Nombre="Mirta Legrand", Dni="70123123", FechaNacimiento=new DateTime(1985,8,15), Email="mirta@yahoo.com", ObraSocial="PAMI"}
        };
